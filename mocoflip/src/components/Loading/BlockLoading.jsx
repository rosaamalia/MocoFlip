...
const ItemFirst = styled(Item)`
  animation: ${props => animateFirst(props.color || '#BE428D')} ${props => props.speed / 4 || 2}s infinite ease-in-out;
`;

const ItemTwo = styled(Item)`
  animation: ${props => animateTwo(props.color || '#BE428D')} ${props => props.speed / 4 || 2}s infinite ease-in-out;
`;

const ItemThree = styled(Item)`
  animation: ${ props => animateThree(props.color || '#BE428D')} ${props => props.speed / 4 || 2}s infinite ease-in-out;
`;

const ItemFour = styled(Item)`
  animation: ${ props => animateFour(props.color || '#BE428D')} ${props => props.speed / 4 || 2}s infinite ease-in-out;
`;
